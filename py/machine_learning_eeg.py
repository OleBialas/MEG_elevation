...
from numpy import vstack, array, mean, std
...
def classify_epochs(epochs, test_size=0.5, decision_function_shape="ovr"):
    ...
    clf = svm.SVC(kernel="linear", decision_function_shape=decision_function_shape)
    clf.fit(X_train, y_train)
    pred_clf=cfl.predict(X_test)
...
def create_dataset(sequences, targets, n_vars=4, n_steps=19):
...
if __name__ =="__main__":
    ...
    pred_clf=classify_epochs(epochs_ica)
